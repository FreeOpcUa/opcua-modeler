...
class Ui_UaModeler(object):
    ...
    def retranslateUi(self, UaModeler):
        ...
        self.actionAddObject.setText(_translate("UaModeler", "addObject"))
        self.actionAddObject.setToolTip(_translate("UaModeler", "add child object to current node"))
        self.actionAddVariable.setText(_translate("UaModeler", "addVariable"))
        self.actionAddObjectType.setText(_translate("UaModeler", "addObjectType"))
        self.actionAddObjectType.setToolTip(_translate("UaModeler", "add new object type as subtype of current node"))
        self.actionAddFolder.setText(_translate("UaModeler", "addFolder"))
        self.actionAddProperty.setText(_translate("UaModeler", "addProperty"))
        self.actionAddDataType.setText(_translate("UaModeler", "addDataType"))
        self.actionAddVariableType.setText(_translate("UaModeler", "addVariableType"))
        self.actionAddReferenceType.setText(_translate("UaModeler", "addReferenceType"))
